...
@Languages
Scenario Outline: Testcase_2 Create langauge details
   Given I successfully SignIn to the Website
   When I navigate to Profile page 
   When I enter '<Language>' and '<Level>'
   Then '<Language>' and '<Level>' should be created  
Examples: 
| Language  | Level            | 
...
Scenario Outline: Testcase_3 Edit language details
 Given I successfully SignIn to the Website
  ...
  Then The record should update '<Language>' and '<Level>'
  Examples: 
  | Language     | Level            |
  | Malayalam    | Fluent           |
...
#Scenario: Testcase_1.1 Verify error for description detail
#    Given I successfully SifnIn to the Website
#	When  I navigate to profile page
#	When I leave description text box empty and try to click save
#	Then Please, a description is required message should popup

#@AddLanguages
#Scenario Outline: Testcase_2 Add Languages to the profile
#   Given  I successfully SignIn to the Website
#	When I navigate to Profile page
#	When I create Language details '<Language>' and '<Level>' to the profile
#	Then The record '<Language>' and '<Level>' should add to the profile page
#	
#	Examples: 
#	| Language  | Level            |
#	| Malayalam | Native/Bilingual |
...
#   Given I Successfully SignIn to the Website
#   When I navigate to Profile page 
#   When I create Language detail to the profile
#   Then New language recors should be created
   
#Scenario Outline: Testcase_2.2 Add two languages to the profile
#   Given I Successfully SignIn to the Website
#   When I navigate to Profile page 
#   When I create Language details '<Language>' and '<Level>" to the profile
#   Then '<Language>' and '<Level>' should be added to the profile
#   Examples: 
#   | Language  | Level            |
#   | Malayalam | NAtive/Bilingual |
#   | English   | Fluent           |
...
#  Then Langauge add option should be cancelled

#Scenario: Testcase_2.5 verify error for langauge detail
#  Given I Successfully SignIn to the Website
#  When I navigate to Profile page
#  When I leave Language textbox blank 
#  Then "Please enter language and level" pop up should display

#Scenario: Testcase_2.6 Verify error for already existing language
#  Given I successfully SignIn to the Website
#  When I navigate to Profile page
...
#Scenario: Testcase_2.7 Verify error for already existing language
#Given I successfully SignIn to the Website
#When I navigate to Profile page
